class Codis::RegistrationsController < Devise::RegistrationsController
...
before_filter :configure_account_update_params, only: [:update]
  ...
  def configure_sign_up_params
    ...
    devise_parameter_sanitizer.for(:sign_up) << :hospital_id
  end
  ...
  def configure_account_update_params
    ...
    devise_parameter_sanitizer.for(:account_update) << :hospital_id
  end
